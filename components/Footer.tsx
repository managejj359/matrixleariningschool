                ...
                <Grid container spacing={4}>
                    ...
                    <Grid size={{ xs: 12, md: 3 }}>
                        ...
                        <Stack direction="row" spacing={1.5}>
                            <IconButton
                                onClick={() => handleWhatsAppClick("Hi Matrix Learning!")}
                            ...
                            <IconButton
                                onClick={() => handleWhatsAppClick("I'm interested in your STEM programs.")}
                            ...
                            <Stack spacing={1.5} sx={{ listStyle: 'none', p: 0, m: 0 }}>
                                {section.links.map((link) => (
                                    <Box component="li" key={link.name}>
                                        <Box
                                            onClick={() => handleWhatsAppClick(`Hi, I'm interested in ${link.name}`)}
                                            sx={{
                                                color: '#6B7280',
                                                textDecoration: 'none',
                                                fontSize: '14px',
